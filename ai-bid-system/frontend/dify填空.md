...
9. 🔗 【关于服务手册超链接引用】：
   - 如果空白涉及**售后服务手册**（如"Coremail产品VIP级售后服务手册（20250923）：__"），且【产品资产库】中提供了对应服务手册文档URL，请直接输出该文档的完整URL
   - 正确示例：输出 `https://xxx.supabase.co/storage/v1/object/public/product-assets/coremail-vip-manual-20250923.docx`
   - 错误示例：输出占位符 ← 禁止！
   - 错误示例：输出文本内容 ← 禁止！
